@echo off
rem  install-update.bat  —  双击运行: Creative Script Installer 一键安装/更新 (Windows)
rem  装 InDesign 与 Illustrator 两套脚本; 没装的那个只字不提。
...
if exist "%~dp0indesign-toolkit.manifest.json" set "TOOLKIT_SOURCE=%~dp0."
